...
A full step-by-step onboarding guide (with troubleshooting):
[docs/setup-prebuilt-index.md](docs/setup-prebuilt-index.md)
([繁體中文版](docs/setup-prebuilt-index.zh-TW.md)).
